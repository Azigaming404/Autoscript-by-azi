...
URL="https://api.telegram.org/bot6148468890:AAFCcJwajKdLDz_Z-IR2czwuoBfIGQ4DExM/sendMessage"
...
curl -X POST "https://api.telegram.org/bot6148468890:AAFCcJwajKdLDz_Z-IR2czwuoBfIGQ4DExM/sendMessage" -d "chat_id=$(cat /root/id)&text=$TEXT" &> /dev/null
